<template>
    <div>
        ...
        <el-card v-loading="pager.loading" class="!border-none" shadow="never">
            <el-button type="primary" v-perms="['content:category:add']" @click="handleEditor('add')">
                <template #icon>
            ...
            <el-table :data="pager.lists" size="large" class="mt-4">
                ...
                <el-table-column label="操作" width="120" fixed="right">
                    <template #default="{ row }">
                        ...
                        <el-button
                            v-perms="['content:category:delete']"
                            type="danger"
                            link
...
const handleDelete = async (id: number): Promise<void> => {
    feedback.confirm('确定要删除此项数据吗?')
        .then(async () => {
            await articleCateApi.delete(id)
