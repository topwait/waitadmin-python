...
class ArticleModel(DbModel):
    ...
    is_topping = fields.BooleanField(null=False, default=False, description="是否置顶")
    is_recommend = fields.BooleanField(null=False, default=False, description="是否推荐")
    is_show = fields.BooleanField(null=False, default=False, description="是否显示")
